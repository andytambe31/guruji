...
const CACHE_VERSION = 'guruji-v151';
const SHELL = [
  './',
  './index.html',
  './css/styles.css',
  ...
  './js/sdi-content.js',
  './js/sdi-ch02.js',
  './js/sdi-cdc-pattern.js',
  './js/sdi-scale1m.js',
  './js/csf-content.js',
  './js/dsa-content.js',
  './js/dsa-heaps.js',
  './js/dsa-linkedlist.js',
  './js/csf-tcptls.js',
  './js/csf-encoding.js',
  './js/csf-llm-patterns.js',
  './js/csf-dynamodb.js',
  './js/csf-snowflake.js',
  './js/csf-wif.js',
  ...
  './js/views/drills.js',
  './js/views/concepts.js',
  './js/views/leetcode-wizard.js',
  './js/views/concept-wizard.js',
  './icons/icon-192.png',
  './icons/icon-512.png',
